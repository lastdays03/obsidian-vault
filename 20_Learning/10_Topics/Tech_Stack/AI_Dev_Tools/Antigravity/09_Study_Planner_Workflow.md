...
## 💡 Key Insights
*   **실패의 가치**: Study Planner의 '고장내며 배우기(Learning by Failure)' 철학은 단순히 읽는 것보다 의도적으로 코드를 에러 내고 수정하는 과정이 훨씬 강력한 기억을 형성함을 시사합니다.
*   **능동적 학습**: 계획(Planning) 단계가 선행됨으로써, 무작정 문서를 읽는 수동적 학습이 아닌 목표 지향적인 능동적 학습으로 전환됩니다.
