...
- [[Obsidian_MCP_Connect_Guide|Obsidian MCP Connect Guide]]: Claude Desktop과 Obsidian을 연결하는 가이드 (uvx 추천).
- [[MCP_Monet_Server]]: Monet.Design 공식 원격(Remote) MCP 서버. React 컴포넌트 자연어 검색 및 자동 삽입 지원.
